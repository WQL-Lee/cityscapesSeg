...
from models import attempt_load_one_weight, guess_model_task, nn, yaml_model_load
...
class YoloSeg(nn.Module):
    ...
    def predict(self, source=None, stream=False, predictor=None, **kwargs):
        ...
        if not self.predictor:
            self.predictor = SegmentationPredictor(overrides=args, _callbacks=self.callbacks)
    ...
    def val(self, validator=None, **kwargs):
        ...
        validator = SegmentationValidator(args=args, _callbacks=self.callbacks)
    ...
    def train(self, trainer=None, **kwargs):
        ...
        self.trainer = SegmentationTrainer(overrides=args, _callbacks=self.callbacks)
